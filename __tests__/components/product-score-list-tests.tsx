...
jest.mock('@/components/product-score', () => (props: { score: number; nutritionValue: number | string[]; productInfo: ProductInformationEnum }) => {
...
describe('ProductScoreList', () => {
  ...
  it('renders title and only scores with available values', () => {
    ...
    const { getByText, queryByText } = render(<ProductScoreList product={mockProduct} />);
